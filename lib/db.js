...
// Serverless hosts give you a read-only project directory and one writable
// scratch dir, so fall back to /tmp there. NOTE: /tmp does not survive between
// invocations — on Vercel the user table is effectively throwaway.
